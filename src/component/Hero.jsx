...
const Hero = () => {
  ...
  >
    <h2 className="text-2xl sm:text-7xl md:text-8xl lg:text-9xl font-black tracking-tight z-10 animate-gradient my-6">
<span className="bg-gradient-to-r from-gray-300 via-gray-600 to-black bg-clip-text text-transparent ">
FASHING
</span>
<span className="mx-2 bg-gradient-to-r from-gray-300 via-gray-600 to-black bg-clip-text text-transparent">
CHANGING
</span>{" "}
<span className="mx-2 bg-gradient-to-r from-gray-300 via-gray-600 to-black bg-clip-text text-transparent">ALWAYS </span>
</h2>
